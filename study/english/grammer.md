...
명사를 대신해서 쓸 수 있는 단어.
대명사는 명사를 대신하여 문장을 간결하게 만들어주는 역할을 가짐

> 어제 **미국인 친구**를 만났어. **미국인 친구**가 한국음식을 엄청 잘 먹어서 그 미국인 친구와 함께 분식집에서 떡볶이를 먹었어.
>
> 어제 **미국인 친구**를 만났어. **걔**가 한국음식을 엄청 잘 먹어서 **걔**랑 같이 분식집에서 떡볶이를 먹었어.



### 인칭대명사

위 예시의 '미국인 친구'처럼 사람을 대신하는 명사를 '인칭대명사'라고 함
예를 들어 `남자 사람 = he, 여자 사람 = she` 라고 쓰는 것

인칭대명사의 경우 주어 자리에는 주격으로, 목적어 자리에는 목적격으로 자리에 맞게 격을 바꿔 사용한다.

'나'가 포함되면 1인칭,
'너'가 포함되면 2인칭,
'나'도 아니고 '너'도 아닌 모든 것을 3인칭
...
- 주격대명사 = 주어 (~은/는/이/가)
  ...
  - 1인칭
    ...
    - 복수: we
      - **We** were raised in Seoul.
  - 2인칭
    - 단수: you
      - **You** missed the bus.
    - 복수: you / you guys
      - **Did you (guys)** use to date? [used to 를 의문문과 부정문에서는 use to 로 사용]
  - 3인칭
    - 단수: he, she, it
      - he is thin-skinned.
    - 복수: they
